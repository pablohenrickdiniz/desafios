    ...
    render: function () {
        ...
        return (
            React.createElement("div", {id: this.state.id}, 
                React.createElement("div", {className: "memoria-container row", style: style}, 
                    cartoes
                ), 
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-md-12"}, 
                        React.createElement("span", {className: "jogo-info"}, "Tempo: ", this.state.tempo.format('HH:mm:ss')), 
                        React.createElement(AudioPlayer, {name: "audio"})
                    )
                )
            )
        );
                                ...
                                self.setState({
                                    ...
                                    if (self.isCompleto()) {
                                        ...
                                        var props = {
                                            id: 'alert-modal',
                                            open: true,
                                            message: React.createElement("span", {className: "jogo-info"}, "Tempo: ", self.state.tempo.format('HH:mm:ss')),
                                            size: 'modal-sm',
                                            type: 'info',
                                            title: 'Jogo Completo!',
