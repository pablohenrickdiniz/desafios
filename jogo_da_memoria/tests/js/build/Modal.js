var Modal = React.createClass({displayName: "Modal",
    ...
    render: function () {
        var close = "";
        if(this.state.close){
            close = React.createElement("button", {type: "button", className: "close", "aria-label": "Close", onClick: this.close}, 
                ...
                React.createElement("div", {className: "modal-dialog" + ' ' + this.state.size}, 
                    React.createElement("div", {className: "modal-content"}, 
                        ...
                        React.createElement("div", {className: "modal-footer", style: !this.state.footer?{display:'none'}:{}}, 
                            ...
                            React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.onConfirm, disabled: this.state.confirmDisabled}, this.state.confirmText)
                        )
                    )
                )
            )
