var NovoJogo = React.createClass({displayName: "NovoJogo",
    ...
    render:function(){
        ...
        return (
            React.createElement(Modal, {title: "Novo Jogo", size: "modal-sm", open: self.state.open, onClose: this.state.onClose}, 
    ...
    itemClick:function(index){
        ...
        if(confirm){
            React.render(
                React.createElement(Jogo, {baralhoUrl: item.url, reiniciar: true}),
